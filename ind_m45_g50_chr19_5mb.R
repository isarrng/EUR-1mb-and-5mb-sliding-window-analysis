...
plink.gen=read.plink("individuals_m45_g50_19.bed",
                     "individuals_m45_g50_19.bim",
                     "individuals_m45_g50_19.fam")
...
for (a in 1:block.nr){
  ...
  plink.block.x=read.plink("individuals_m45_g50_19.bed",
                           "individuals_m45_g50_19.bim",
                           "individuals_m45_g50_19.fam",select.snps=b.df$block.x.names)
...
saveRDS(results.array, file="ind_m45_g50_19_5mb_res.RData")

if (length(diff.test)>0){
  saveRDS(diff.test, file="ind_m45_g50_19_5mb_diff.RData")
}
