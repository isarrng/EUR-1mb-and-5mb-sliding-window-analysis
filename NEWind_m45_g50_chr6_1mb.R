...
plink.gen=read.plink("individuals_m45_g50_6.bed",
                     "individuals_m45_g50_6.bim",
                     "individuals_m45_g50_6.fam")
...
for (a in 1:block.nr){
  ...
  plink.block.x=read.plink("individuals_m45_g50_6.bed",
                           "individuals_m45_g50_6.bim",
                           "individuals_m45_g50_6.fam",select.snps=b.df$block.x.names)
...
saveRDS(results.array, file="NEWind_m45_g50_6_1mb_res.RData")

if (length(diff.test)>0){
  saveRDS(diff.test, file="NEWind_m45_g50_6_1mb_diff.RData")
}
