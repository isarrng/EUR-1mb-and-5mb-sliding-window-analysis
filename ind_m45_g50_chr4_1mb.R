...
plink.gen=read.plink("individuals_m45_g50_4.bed",
                     "individuals_m45_g50_4.bim",
                     "individuals_m45_g50_4.fam")
...
for (a in 1:block.nr){
  ...
  plink.block.x=read.plink("individuals_m45_g50_4.bed",
                           "individuals_m45_g50_4.bim",
                           "individuals_m45_g50_4.fam",select.snps=b.df$block.x.names)
...
saveRDS(results.array, file="ind_m45_g50_4_1mb_res.RData")

if (length(diff.test)>0){
  saveRDS(diff.test, file="ind_m45_g50_4_1mb_diff.RData")
}
